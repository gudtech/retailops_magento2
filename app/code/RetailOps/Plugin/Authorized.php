...
namespace Shiekhdev\RetailOps\Plugin;
...
class Authorized
{
    const integration_key_value = 'retailops/Shiekhdev_RetailOps/password';
    ...
    public function aroundDispatch($subject, $proceed, $request)
    {
        try{
            ...
            $logger = ObjectManager::getInstance()->get('\Shiekhdev\RetailOps\Logger\Logger');
