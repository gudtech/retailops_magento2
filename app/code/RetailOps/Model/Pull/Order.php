<?php
namespace Shiekhdev\RetailOps\Model\Pull;
...
class Order
{
    ...
    protected function getNextPageToken()
    {
        ...
        {
            $service = $this->ObjectManager->get('\Shiekhdev\RetailOps\Service\NumberPageToken');
    ...
    public function __construct(\Magento\Sales\Api\OrderRepositoryInterface $OrderRepository,
                                   ...
                                   \Shiekhdev\RetailOps\Model\Api\Map\Order $RetailOrderMaps)
    {
