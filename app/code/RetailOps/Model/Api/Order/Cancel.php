...
class Cancel
{
    use \Shiekhdev\RetailOps\Model\Api\Traits\Filter;

    protected $response;
    protected $status = 'success';
    protected $events = [];
    /**
     * @var \Shiekhdev\RetailOps\Model\Order\Status\History
     */
    ...
    public function __construct(\Magento\Sales\Api\OrderRepositoryInterface $orderRepository,
                                ...
                                \Shiekhdev\RetailOps\Model\Order\Status\History $historyRetail
    )
    {
